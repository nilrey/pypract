...
class JsonSaveDB():
    ...
    def set_qparams(self, orig_id):
        self.qparams['chain_id'] = dbq.getUuid()
        self.qparams['chain_orig_id'] = orig_id
        self.qparams['author_id'] = self.get_author_id()

    def set_file_id(self, fname):
        self.qparams['file_id'] = "1ca4627c-7b58-11ef-b565-0242ac140002" #self.get_file_id(fname)
    ...
    def collect_chain_params(self)->list:
        params = [self.qparams['chain_id'], 'nil_test', self.qparams['dataset_id'], 'vector', 'description', self.qparams['author_id'], self.qparams['cur_datetime'], False, self.qparams['file_id'], '', self.qparams['chain_orig_id']]
        return params
    ...
    def parse_content(self, content):
        ...
        for f in content['files']:
            for chain in f['file_chains'] :
                ...
                self.set_qparams(chain['chain_id'])
